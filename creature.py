...
class Creature:
    def __init__(self):
        ...
        self.model.worldbody.add('geom', type='plane', size=(100, 100, 0.1), pos=(0, 0, -10))
        ...
        self.body.add('geom', type='sphere', size=(self.init_body_size, self.init_body_size, self.init_body_size))
...
class CreatureGenerator:
    ...
    def randomize_creature(self, creature):
        ...
        for joint in creature.model.find_all('joint'):
            creature.model.actuator.add('motor', joint=joint, ctrllimited='true', ctrlrange=(-1, 1))
        return creature
